...
<head>
    ...
    <title>Étiquette Flightcase - Chantier {{ $chantier->id }}</title>
    <style>
    ...
    <div class="preview-container">
        <div class="controls">
            ...
            <div>
                ...
                <a href="{{ route('chantiers.show', $chantier->id) }}" class="btn btn-back">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="etiquette-container">
            <div class="etiquette-flightcase">
                ...
                <div class="etiquette-header">
                    <img src="{{ asset('images/Logo rectangle flag.png') }}" alt="Logo TecaLED" class="logo">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function createAndDownloadPDF() {
                ...
                try {
                    ...
                    html2canvas(element, {
                        ...
                        // Télécharger le PDF
                        pdf.save('etiquette-chantier-{{ $chantier->id }}.pdf');
            ...
            function printBrother() {
                ...
                fetch('{{ route("etiquettes.chantier.ptouch", $chantier->id) }}', {
                    method: 'GET',
                    headers: {
