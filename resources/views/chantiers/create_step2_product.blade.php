<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white leading-tight">
            {{ __('Création de projet - Étape 2/5 : Produit') }}
        </h2>
    </x-slot>
            ...
            <div class="glassmorphism overflow-hidden shadow-lg rounded-xl">
                <div class="p-6 border-b border-gray-700">
                    ...
                    <div class="mb-6 bg-blue-900/30 border border-blue-500/30 p-4 rounded-xl">
                        ...
                        <p class="text-gray-300"><span class="font-medium">Société:</span> {{ $client->societe ?: 'Non spécifiée' }}</p>
                        <p class="text-gray-300"><span class="font-medium">Adresse:</span> {{ $client->adresse }}, {{ $client->code_postal }} {{ $client->ville }}</p>
                    </div>

                    <form id="productForm" method="POST" action="{{ route('chantiers.store.step2') }}">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="from_catalogue_1" class="flex items-center p-4 border border-gray-700 rounded-xl cursor-pointer transition-all hover:border-accent-blue hover:bg-gray-800/50 @error('from_catalogue') border-red-500 @enderror" id="catalogue_container">
                                        <input type="radio" name="from_catalogue" id="from_catalogue_1" value="1" class="mr-2 accent-accent-blue" {{ old('from_catalogue', 1) == '1' ? 'checked' : '' }}>
                                        <div>
                                ...
                                <div>
                                    <label for="from_catalogue_0" class="flex items-center p-4 border border-gray-700 rounded-xl cursor-pointer transition-all hover:border-accent-blue hover:bg-gray-800/50 @error('from_catalogue') border-red-500 @enderror" id="nouveau_container">
                                        <input type="radio" name="from_catalogue" id="from_catalogue_0" value="0" class="mr-2 accent-accent-blue" {{ old('from_catalogue') == '0' ? 'checked' : '' }}>
                                        <div>
                            ...
                            @error('from_catalogue')
                                <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                            @enderror
                        </div>
                        
                        <!-- Sélection du produit du catalogue avec moteur de recherche avancé -->
                        <div id="catalogue_form" class="mb-6 p-4 border border-gray-700 rounded-xl bg-gray-800/30 {{ old('from_catalogue', 1) == '1' ? '' : 'hidden' }}">
                            ...
                            <div x-data="advancedProductSearch()" class="mb-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                    <div>
                                        <x-input-label for="search_marque" :value="__('Marque')" class="text-gray-300" />
                                    ...
                                    <div>
                                        <x-input-label for="search_modele" :value="__('Modèle/Référence')" class="text-gray-300" />
                                        <input type="text" id="search_modele" x-model="filters.modele" placeholder="Filtrer par modèle..." 
                                            class="block mt-1 w-full rounded-md bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                                    </div>
                                    
                                    <div>
                                        <x-input-label for="search_pitch" :value="__('Pitch (mm)')" class="text-gray-300" />
                                        <input type="number" id="search_pitch" x-model="filters.pitch" placeholder="Filtrer par pitch..." step="0.1" min="0.1" max="100"
                                            class="block mt-1 w-full rounded-md bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                                    </div>
                                    
                                    <div>
                                        <x-input-label for="search_bain" :value="__('Bain de couleur')" class="text-gray-300" />
                                        <input type="text" id="search_bain" x-model="filters.bain" placeholder="Filtrer par type de bain..." 
                                            class="block mt-1 w-full rounded-md bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                                    </div>
                                    
                                    <div>
                                        <x-input-label for="search_utilisation" :value="__('Utilisation')" class="text-gray-300" />
                        ...
                        <div id="nouveau_form" class="mb-6 {{ old('from_catalogue') == '0' ? '' : 'hidden' }}">
                            ...
                            <div class="p-4 border border-gray-700 rounded-xl bg-gray-800/30 mb-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <x-marque-autocomplete label="Marque" placeholder="Recherchez ou saisissez une marque..." required="false" />
                                        <input type="hidden" id="marque" name="marque" value="{{ old('marque') }}">
                                        <x-input-error :messages="$errors->get('marque')" class="mt-2" />
                                    </div>
                                    
                                    <div>
                                        <x-modele-autocomplete label="Modèle" placeholder="Recherchez ou saisissez un modèle..." required="false" />
                                        <input type="hidden" id="modele" name="modele" value="{{ old('modele') }}">
                                        <x-input-error :messages="$errors->get('modele')" class="mt-2" />
                                    </div>
                                    
                                    <div>
                                        <x-input-label for="largeur_dalle" :value="__('Largeur de dalle (mm)')" class="text-gray-300" />
                                        <x-text-input id="largeur_dalle" class="block mt-1 w-full bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="number" name="largeur_dalle" :value="old('largeur_dalle', 500)" min="1" required />
                                        <x-input-error :messages="$errors->get('largeur_dalle')" class="mt-2" />
                                    </div>
                                    
                                    <div>
                                        <x-input-label for="hauteur_dalle" :value="__('Hauteur de dalle (mm)')" class="text-gray-300" />
                                        <x-text-input id="hauteur_dalle" class="block mt-1 w-full bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="number" name="hauteur_dalle" :value="old('hauteur_dalle', 500)" min="1" required />
                            ...
                            <div class="p-4 border border-gray-700 rounded-xl bg-gray-800/30 mb-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div>
                                        ...
                                        <x-text-input id="pitch" class="block mt-1 w-full bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="number" name="pitch" :value="old('pitch')" step="0.1" min="0.1" max="100" placeholder="Ex: 2.5" />
                                ...
                                <div class="mt-6 p-3 border border-gray-700 rounded-lg bg-gray-800/50">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <x-input-label for="largeur_module" :value="__('Largeur du module (mm)')" class="text-gray-300" />
                                            <x-text-input id="largeur_module" class="block mt-1 w-full bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="number" name="largeur_module" :value="old('largeur_module', 250)" min="1" required />
                                            <x-input-error :messages="$errors->get('largeur_module')" class="mt-2" />
                                        </div>
                                        
                                        <div>
                                            <x-input-label for="hauteur_module" :value="__('Hauteur du module (mm)')" class="text-gray-300" />
                                            <x-text-input id="hauteur_module" class="block mt-1 w-full bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="number" name="hauteur_module" :value="old('hauteur_module', 250)" min="1" required />
                                ...
                                <div class="mt-4 p-3 border border-gray-700 rounded-lg bg-gray-800/50">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div>
                                            <x-driver-autocomplete label="Driver (IC de commande)" placeholder="Recherchez ou saisissez un driver..." required="false" />
                                            <input type="hidden" id="driver" name="driver" value="{{ old('driver') }}">
                                ...
                                <div class="mt-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        <div class="md:col-span-2">
                                            ...
                                            <div class="grid grid-cols-2 md:grid-cols-4 gap-2 mb-4">
                                                <label for="disposition_2x2" class="disposition-option flex flex-col items-center justify-center p-2 border border-gray-700 rounded-lg cursor-pointer transition-all hover:border-accent-blue">
                                                    <input type="radio" id="disposition_2x2" name="disposition_modules" value="2x2" class="sr-only" {{ old('disposition_modules', '2x2') == '2x2' ? 'checked' : '' }}>
                                                ...
                                                <label for="disposition_3x3" class="disposition-option flex flex-col items-center justify-center p-2 border border-gray-700 rounded-lg cursor-pointer transition-all hover:border-accent-blue">
                                                    <input type="radio" id="disposition_3x3" name="disposition_modules" value="3x3" class="sr-only" {{ old('disposition_modules') == '3x3' ? 'checked' : '' }}>
                                                ...
                                                <label for="disposition_4x4" class="disposition-option flex flex-col items-center justify-center p-2 border border-gray-700 rounded-lg cursor-pointer transition-all hover:border-accent-blue">
                                                    <input type="radio" id="disposition_4x4" name="disposition_modules" value="4x4" class="sr-only" {{ old('disposition_modules') == '4x4' ? 'checked' : '' }}>
                                                ...
                                                <label for="disposition_personnalise" class="disposition-option flex flex-col items-center justify-center p-2 border border-gray-700 rounded-lg cursor-pointer transition-all hover:border-accent-blue">
                                                    <input type="radio" id="disposition_personnalise" name="disposition_modules" value="personnalise" class="sr-only" {{ old('disposition_modules') == 'personnalise' ? 'checked' : '' }}>
                                        ...
                                        <div id="disposition_personnalisee" class="md:col-span-2 p-4 border border-gray-700 rounded-lg bg-gray-800/50 {{ old('disposition_modules') == 'personnalise' ? '' : 'hidden' }}">
                                            ...
                                            <div class="grid grid-cols-2 gap-4 mb-4">
                                                <div>
                                                    ...
                                                    <x-text-input id="modules_largeur" class="block mt-1 w-full bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="number" name="modules_largeur" :value="old('modules_largeur', 2)" min="1" max="10" />
                                                </div>
                                                
                                                <div>
                                                    <x-input-label for="modules_hauteur" :value="__('Modules en hauteur')" class="text-gray-300" />
                                                    <x-text-input id="modules_hauteur" class="block mt-1 w-full bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="number" name="modules_hauteur" :value="old('modules_hauteur', 2)" min="1" max="10" />
                                                </div>
                                            </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div id="custom_carte_container" class="mt-2 hidden">
                                            <x-text-input id="custom_carte_reception" class="block w-full bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="text" placeholder="Ex: Novastar Taurus TB6" />
                                        </div>
                                    </div>
                            ...
                            <div class="p-4 border border-gray-700 rounded-xl bg-gray-800/30">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-5 gap-4">
                                    <div>
                                        ...
                                        <div id="led_existant_container" class="mb-4 hidden">
                                            ...
                                            <select id="led_existant_select" name="led_existant_select" class="block mt-1 w-full rounded-md bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                                                ...
                                                @foreach($ledDatasheets as $datasheet)
                                                    @php
                                                    ...
                                                    @endphp
                                                    <option value="{{ $datasheet->id }}" 
                                                            data-reference="{{ $datasheet->reference }}"
                                                            data-type="{{ $datasheet->type }}"
                                                            data-size="{{ !empty($parts[1]) ? $parts[1] : '' }}"
                                                            data-color="{{ $datasheet->color ?? 'black' }}"
                                                            data-pads="{{ $datasheet->nb_poles ?? 4 }}"
                                                            data-config="{{ json_encode($datasheet->configuration_poles ?? []) }}">
                                                        {{ $description }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div id="led_nouveau_container" class="grid grid-cols-1 md:grid-cols-3 gap-4 md:col-span-2">
                                        ...
                                        <div>
                                            <x-input-label for="led_color" :value="__('Couleur du PCB')" class="text-gray-300" />
                                            <select id="led_color" name="led_color" class="block mt-1 w-full rounded-md bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                                                <option value="black" {{ old('led_color') == 'black' ? 'selected' : '' }}>Black (Noir)</option>
                                                <option value="white" {{ old('led_color') == 'white' ? 'selected' : '' }}>White (Blanc)</option>
                                            </select>
                                            <x-input-error :messages="$errors->get('led_color')" class="mt-2" />
                                        </div>
                        ...
                        <div id="add_to_catalogue_container" class="mb-6 p-4 border border-gray-600 rounded-xl bg-blue-900/20 {{ old('from_catalogue') == '0' ? '' : 'hidden' }}">
                            <div class="flex items-center">
                                <input type="checkbox" id="add_to_catalogue" name="add_to_catalogue" value="1" {{ old('add_to_catalogue') ? 'checked' : '' }} class="mr-2 rounded bg-gray-700 border-gray-600 text-blue-500 focus:ring-blue-500">
    ...
    <script src="{{ asset('js/components/carte-reception-selector.js') }}"></script>
    <script src="{{ asset('js/components/autocomplete.js') }}"></script>
    <script src="{{ asset('js/components/advanced-product-search.js') }}"></script>
    <script src="{{ asset('js/components/led-datasheet-viewer.js') }}"></script>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
