                    ...
                    <form method="POST" action="{{ route('admin.users.update', $user) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="name" class="block mt-1 w-full bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring focus:ring-indigo-500/50" type="text" name="name" :value="old('name', $user->name)" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="email" class="block mt-1 w-full bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring focus:ring-indigo-500/50" type="email" name="email" :value="old('email', $user->email)" required />
