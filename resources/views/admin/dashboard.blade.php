    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                ...
                <div class="glassmorphism-static rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-lg border border-indigo-500/20 hover:border-indigo-500/40">
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex justify-end">
                            <a href="{{ route('admin.users') }}" class="btn-action btn-primary inline-flex items-center transition-transform hover:scale-105">
                ...
                <div class="glassmorphism-static rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-lg border border-amber-500/20 hover:border-amber-500/40">
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex justify-end">
                            <a href="{{ route('chantiers.index') }}" class="btn-action btn-primary inline-flex items-center transition-transform hover:scale-105">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                                </svg>
                                Gérer
                ...
                <div class="glassmorphism-static rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-lg border border-cyan-500/20 hover:border-cyan-500/40">
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex justify-end">
                            <a href="{{ route('admin.database.manager') }}" class="btn-action btn-primary inline-flex items-center transition-transform hover:scale-105">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                                </svg>
                                Gérer
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                <!-- Clients -->
                <a href="{{ route('clients.index') }}" class="glassmorphism-static flex flex-col items-center p-5 rounded-2xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl text-center">
                ...
                <!-- Produits -->
                <a href="{{ route('produits.index') }}" class="glassmorphism-static flex flex-col items-center p-5 rounded-2xl border border-green-500/20 hover:border-green-500/40 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl text-center">
                ...
                <!-- Dalles -->
                <a href="{{ route('dalles.index') }}" class="glassmorphism-static flex flex-col items-center p-5 rounded-2xl border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl text-center">
                ...
                <!-- Modules -->
                <a href="{{ route('modules.index') }}" class="glassmorphism-static flex flex-col items-center p-5 rounded-2xl border border-rose-500/20 hover:border-rose-500/40 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl text-center">
                ...
                <!-- Interventions -->
                <a href="{{ route('interventions.index') }}" class="glassmorphism-static flex flex-col items-center p-5 rounded-2xl border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl text-center">
                ...
                <!-- Rapports -->
                <a href="{{ route('rapports.index') }}" class="glassmorphism-static flex flex-col items-center p-5 rounded-2xl border border-amber-500/20 hover:border-amber-500/40 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl text-center">
