<section class="space-y-6">
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6 glassmorphism">
            @csrf
            @method('delete')
            ...
            <div class="mt-6">
                ...
                <x-text-input
                    ...
                    name="password"
                    type="password"
                    class="mt-1 block w-3/4 bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring focus:ring-indigo-500/50"
