...
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames(([
    'label' => 'Driver IC',
    'placeholder' => 'Recherchez ou saisissez un driver...',
    'required' => false
]));
...
<div x-data="driverAutocomplete()" <?php echo e($attributes->merge(['class' => 'mb-4'])); ?>>
    ...
    <div x-show="showResults" class="absolute mt-1 w-full max-w-lg bg-gray-800 border border-gray-700 rounded-md shadow-lg z-50 max-h-60 overflow-y-auto">
        <ul class="py-1">
            <template x-for="driver in results" :key="driver.id">
                <li @click="selectDriver(driver)" class="px-4 py-2 hover:bg-gray-700 cursor-pointer">
                    <div x-text="driver.text" class="font-medium text-white"></div>
                </li>
            </template>
        </ul>
    </div>
</div><?php /**PATH /var/www/gmao/resources/views/components/driver-autocomplete.blade.php ENDPATH**/ ?>