                                    ...
                                    <div id="leds-counter" class="bg-gray-800/80 rounded-lg p-4 text-center border border-blue-600/30 shadow">
                                        ...
                                        <div class="flex items-center justify-center space-x-4">
                                            ...
                                            <div class="counter-display text-4xl font-bold text-blue-500 w-16">
                                                <?php echo e(old('diagnostic_nb_leds_hs', $intervention->diagnostic->nb_leds_hs ?? 0)); ?>
                                        ...
                                        <input id="diagnostic_nb_leds_hs" type="hidden" name="diagnostic_nb_leds_hs" value="<?php echo e(old('diagnostic_nb_leds_hs', $intervention->diagnostic->nb_leds_hs ?? 0)); ?>" />
                                    </div>
                                    ...
                                    <div id="ics-counter" class="bg-gray-800/80 rounded-lg p-4 text-center border border-purple-600/30 shadow">
                                        ...
                                        <div class="flex items-center justify-center space-x-4">
                                            ...
                                            <div class="counter-display text-4xl font-bold text-purple-500 w-16">
                                                <?php echo e(old('diagnostic_nb_ic_hs', $intervention->diagnostic->nb_ic_hs ?? 0)); ?>
                                        ...
                                        <!-- Champ caché pour stocker la valeur -->
                                        <input id="diagnostic_nb_ic_hs" type="hidden" name="diagnostic_nb_ic_hs" value="<?php echo e(old('diagnostic_nb_ic_hs', $intervention->diagnostic->nb_ic_hs ?? 0)); ?>" />
                                    </div>
                                    ...
                                    <div id="masques-counter" class="bg-gray-800/80 rounded-lg p-4 text-center border border-amber-600/30 shadow">
                                        ...
                                        <div class="flex items-center justify-center space-x-4">
                                            ...
                                            <div class="counter-display text-4xl font-bold text-amber-500 w-16">
                                                <?php echo e(old('diagnostic_nb_masques_hs', $intervention->diagnostic->nb_masques_hs ?? 0)); ?>
                                        ...
                                        <!-- Champ caché pour stocker la valeur -->
                                        <input id="diagnostic_nb_masques_hs" type="hidden" name="diagnostic_nb_masques_hs" value="<?php echo e(old('diagnostic_nb_masques_hs', $intervention->diagnostic->nb_masques_hs ?? 0)); ?>" />
                                    </div>
                                </div>
...
<?php endif; ?>
    ...
    <script src="<?php echo e(asset('js/intervention-counters.js')); ?>"></script>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
