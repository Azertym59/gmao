        ...
        <div class="hero-section">
            ...
            <div class="container mx-auto px-4 relative z-10">
                <div class="max-w-4xl mx-auto">
                    <img src="<?php echo e(asset('images/Logo rectangle V2.png')); ?>" alt="TecaLED Logo" class="h-24 md:h-32 mx-auto mb-8">
                    ...
                    <p class="text-xl md:text-2xl mb-8 font-medium text-accent-secondary">Bienvenue <?php echo e(auth()->user()->client->civilite); ?> <?php echo e(auth()->user()->client->getNomCompletSansDoublonAttribute()); ?></p>
                    <?php endif; ?>
                    <div class="flex flex-wrap gap-4 justify-center mt-8">
                        <?php if(\Illuminate\Support\Facades\Route::has('login')): ?>
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(url('/dashboard')); ?>" class="btn-primary px-8 py-4 rounded-lg font-semibold text-base md:text-lg">Accéder au tableau de bord</a>
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="btn-secondary px-8 py-4 rounded-lg font-semibold text-base md:text-lg">Connexion</a>
                                <?php if(\Illuminate\Support\Facades\Route::has('register')): ?>
                                    <a href="<?php echo e(route('register')); ?>" class="btn-outline px-8 py-4 rounded-lg font-semibold text-base md:text-lg">Inscription</a>
                                <?php endif; ?>
                            <?php endif; ?>
                        <?php endif; ?>
                        <a href="<?php echo e(route('client.login')); ?>" class="btn-primary px-8 py-4 rounded-lg font-semibold text-base md:text-lg">Espace Client</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container mx-auto px-4 relative z-10">
                <div class="max-w-3xl mx-auto text-center">
                    ...
                    <div class="flex flex-wrap gap-4 justify-center">
                        <a href="<?php echo e(route('login')); ?>" class="btn-primary px-8 py-4 rounded-lg font-semibold text-base md:text-lg">Commencer maintenant</a>
                        <a href="<?php echo e(route('client.login')); ?>" class="btn-secondary px-8 py-4 rounded-lg font-semibold text-base md:text-lg">Espace Client</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <footer class="footer">
            <div class="container mx-auto px-4 py-8">
                <div class="flex flex-col items-center">
                    <img src="<?php echo e(asset('images/logo carré tecaled impression flag.png')); ?>" alt="TecaLED Logo" class="h-16 mb-4">
                    <p class="text-gray-400 mb-4">© <?php echo e(date('Y')); ?> TecaLED - GMAO. Tous droits réservés.</p>
