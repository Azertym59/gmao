...
<?php $component->withAttributes([]); ?>
    ...
    <div class="space-y-6">
        ...
        <div class="glassmorphism rounded-lg overflow-hidden shadow-lg">
            <form action="<?php echo e(route('printers.store')); ?>" method="POST" class="p-6 space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <select name="model" id="model" 
                        ...
                        <option value="Brother QL-820NWB" <?php echo e(old('model') == 'Brother QL-820NWB' ? 'selected' : ''); ?>>Brother QL-820NWB</option>
                        <option value="Brother QL-800" <?php echo e(old('model') == 'Brother QL-800' ? 'selected' : ''); ?>>Brother QL-800</option>
                        <option value="Brother QL-700" <?php echo e(old('model') == 'Brother QL-700' ? 'selected' : ''); ?>>Brother QL-700</option>
                        <option value="Zebra ZD410" <?php echo e(old('model') == 'Zebra ZD410' ? 'selected' : ''); ?>>Zebra ZD410</option>
                        <option value="Dymo LabelWriter 450" <?php echo e(old('model') == 'Dymo LabelWriter 450' ? 'selected' : ''); ?>>Dymo LabelWriter 450</option>
                        <option value="Autre" <?php echo e(old('model') == 'Autre' ? 'selected' : ''); ?>>Autre</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="connection_type" id="connection_type" 
                        ...
                        <option value="network" <?php echo e(old('connection_type') == 'network' ? 'selected' : ''); ?>>Réseau (IP)</option>
                        <option value="usb" <?php echo e(old('connection_type') == 'usb' ? 'selected' : ''); ?>>USB</option>
                        <option value="bluetooth" <?php echo e(old('connection_type') == 'bluetooth' ? 'selected' : ''); ?>>Bluetooth</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="label_format" id="label_format" 
                        ...
                        <option value="62mm" <?php echo e(old('label_format') == '62mm' ? 'selected' : ''); ?>>62mm (standard)</option>
                        <option value="29mm" <?php echo e(old('label_format') == '29mm' ? 'selected' : ''); ?>>29mm (petite)</option>
                        <option value="102mm" <?php echo e(old('label_format') == '102mm' ? 'selected' : ''); ?>>102mm (large)</option>
                        <option value="17mm" <?php echo e(old('label_format') == '17mm' ? 'selected' : ''); ?>>17mm (très petite)</option>
                        <option value="custom" <?php echo e(old('label_format') == 'custom' ? 'selected' : ''); ?>>Format personnalisé</option>
                    </select>
                </div>
                ...
                <div id="custom_format_container" class="hidden">
                    ...
                    <div class="flex space-x-3">
                        <input type="number" name="custom_width" id="custom_width" value="<?php echo e(old('custom_width')); ?>" 
                        ...
                        <input type="number" name="custom_height" id="custom_height" value="<?php echo e(old('custom_height')); ?>" 
                               class="w-1/2 bg-gray-800/50 border border-gray-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-accent-blue focus:border-transparent"
                               placeholder="Hauteur">
                    </div>
                </div>
                ...
                <div class="border-t border-gray-700 pt-6">
                    ...
                    <div>
                        ...
                        <select name="dpi" id="dpi" 
                                class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-accent-blue focus:border-transparent">
                            <option value="300" <?php echo e(old('dpi', '300') == '300' ? 'selected' : ''); ?>>300 DPI (standard)</option>
                            <option value="600" <?php echo e(old('dpi') == '600' ? 'selected' : ''); ?>>600 DPI (haute qualité)</option>
                            <option value="203" <?php echo e(old('dpi') == '203' ? 'selected' : ''); ?>>203 DPI (basse qualité)</option>
                        </select>
                    </div>
                </div>
...
<?php endif; ?><?php /**PATH /var/www/gmao/resources/views/printers/create.blade.php ENDPATH**/ ?>