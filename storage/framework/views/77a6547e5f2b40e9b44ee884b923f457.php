        ...
        <div class="glassmorphism rounded-lg overflow-hidden shadow-lg">
            ...
            <div class="p-4 flex flex-col items-center">
                <div class="bg-white p-2 rounded border border-gray-300 mb-4" style="width: 100px; height: 42px;">
                    <img src="<?php echo e($moduleQR); ?>" alt="QR Code Module" class="w-full">
                </div>
                
                <button onclick="window.open('<?php echo e(route('etiquettes.test.module')); ?>', '_blank')" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg shadow flex items-center">
        ...
        <div class="glassmorphism rounded-lg overflow-hidden shadow-lg">
            ...
            <div class="p-4 flex flex-col items-center">
                <div class="bg-white p-2 rounded border border-gray-300 mb-4" style="width: 124px; height: 65px;">
                    <img src="<?php echo e($dalleQR); ?>" alt="QR Code Dalle" class="w-full">
                </div>
                
                <button onclick="window.open('<?php echo e(route('etiquettes.test.dalle')); ?>', '_blank')" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg shadow flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" />
                    </svg>
                    Tester impression
        ...
        <div class="glassmorphism rounded-lg overflow-hidden shadow-lg">
            ...
            <div class="p-4 flex flex-col items-center">
                <div class="bg-white p-2 rounded border border-gray-300 mb-4" style="width: 150px; height: 150px;">
                    <img src="<?php echo e($chantierQR); ?>" alt="QR Code Chantier" class="w-full">
                </div>
                
                <button onclick="window.open('<?php echo e(route('etiquettes.test.flightcase')); ?>', '_blank')" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg shadow flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" />
                    </svg>
                    Tester impression
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/gmao/resources/views/etiquettes/test.blade.php ENDPATH**/ ?>