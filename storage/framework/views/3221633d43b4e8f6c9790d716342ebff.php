    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 px-2">
                ...
                <div>
                    <a href="<?php echo e(route('clients.create')); ?>" class="btn bg-white text-gray-900 hover:bg-gray-100 hover:scale-105 transition-transform">
            ...
            <div class="card">
                <div class="card-body p-0">
                        ...
                        <table class="table-styled">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="font-medium"><?php echo e($client->nom_complet); ?></td>
                                        <td><?php echo e($client->societe); ?></td>
                                        <td>
                                            <a href="mailto:<?php echo e($client->email); ?>" class="text-accent-blue hover:underline flex items-center">
                                        ...
                                        <td>
                                            <a href="tel:<?php echo e($client->telephone); ?>" class="text-text-primary hover:text-accent-blue flex items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <tr>
                                        <td colspan="5" class="py-8 text-center">
                                            <div class="flex flex-col items-center justify-center space-y-3">
                                                ...
                                                <a href="<?php echo e(route('clients.create')); ?>" class="btn bg-white text-gray-900 hover:bg-gray-100 hover:scale-105 transition-transform mt-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                                    </svg>
                    ...
                    <?php if(isset($clients) && method_exists($clients, 'links')): ?>
...
<?php endif; ?><?php /**PATH /var/www/gmao/resources/views/clients/index.blade.php ENDPATH**/ ?>