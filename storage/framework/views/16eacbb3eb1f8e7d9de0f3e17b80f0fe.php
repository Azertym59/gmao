...
<head>
    ...
    <title>Module <?php echo e($module->reference_module); ?> - Détails</title>
...
<body>
            ...
            <div class="container header-container">
                <div class="header-logo">
                    ...
                    <div class="header-title">
                        ...
                        <span><?php echo e($module->dalle->reference_dalle); ?> - <?php echo e($module->dalle->produit->marque); ?> <?php echo e($module->dalle->produit->modele); ?></span>
                    </div>
                </div>
                <div class="header-info">
                    <div class="ref-badge">
                        ...
                        Module: <?php echo e(str_replace('Ind', 'Mod', $module->reference_module)); ?>

                    </div>
                    <div class="header-buttons">
                        <a href="<?php echo e(route('suivi.chantier', $token)); ?>" class="icon-button" title="Retour au chantier">
        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="status-badge status-<?php echo e($module->etat); ?>">
                        <span class="status-indicator indicator-<?php echo e($module->etat); ?>"></span>
                        <?php if($module->etat == 'non_commence'): ?>
                            Non commencé
                        <?php elseif($module->etat == 'en_cours'): ?>
                            En cours
                        <?php elseif($module->etat == 'termine'): ?>
                            Terminé
                ...
                <div class="card-body">
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value"><?php echo e($module->reference_module); ?></div>
                        </div>
                        
                        <div class="info-item">
                            <div class="info-label">ID Usine / Numéro de série</div>
                            <div class="info-value"><?php echo e($module->numero_serie ?: 'Non renseigné'); ?></div>
                        </div>
                        
                        <div class="info-item">
                            <div class="info-label">Disposition</div>
                            <div class="info-value"><?php echo e($module->disposition ?: 'Standard'); ?></div>
                        </div>
                        
                        <div class="info-item">
                            <div class="info-label">Dimensions</div>
                            <div class="info-value"><?php echo e($module->largeur); ?> × <?php echo e($module->hauteur); ?> mm</div>
                        </div>
                        
                        <div class="info-item">
                            <div class="info-label">Résolution</div>
                            <div class="info-value"><?php echo e($module->nb_pixels_largeur); ?> × <?php echo e($module->nb_pixels_hauteur); ?> px</div>
                        </div>
                        
                        <div class="info-item">
                            <div class="info-label">Dalle / Produit</div>
                            <div class="info-value"><?php echo e($module->dalle->reference_dalle); ?></div>
                            <div style="font-size: 0.75rem; color: var(--text-muted);"><?php echo e($module->dalle->produit->marque); ?> <?php echo e($module->dalle->produit->modele); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span style="font-size: 0.875rem; color: var(--text-muted);"><?php echo e($module->interventions->count()); ?> intervention(s)</span>
                </div>
                <div class="card-body">
                    <?php if($module->interventions->count() > 0): ?>
                        <div class="timeline">
                            <?php $__currentLoopData = $module->interventions->sortByDesc('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $intervention): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="timeline-item">
                                <div class="timeline-dot"></div>
                                <div class="timeline-content">
                                    <div class="timeline-header">
                                        <div class="timeline-title">Intervention #<?php echo e($intervention->id); ?></div>
                                    ...
                                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                                        <div style="font-size: 0.875rem;">
                                            ...
                                            <span style="font-weight: 500;"><?php echo e($intervention->technicien ? $intervention->technicien->name : 'Non assigné'); ?></span>
                                        </div>
                                        <div class="status-badge <?php echo e($intervention->is_completed ? 'status-termine' : 'status-en_cours'); ?>" style="font-size: 0.75rem; padding: 0.25rem 0.5rem;">
                                            <span class="status-indicator <?php echo e($intervention->is_completed ? 'indicator-termine' : 'indicator-en_cours'); ?>"></span>
                                            <?php echo e($intervention->is_completed ? 'Terminée' : 'En cours'); ?>
                                    ...
                                    <div>
                                        ...
                                        <div class="data-grid">
                                            <div class="data-item">
                                                ...
                                                <div class="data-value"><?php echo e($intervention->diagnostic->nb_leds_hs); ?></div>
                                            </div>
                                            
                                            <div class="data-item">
                                                <div class="data-label">ICs défectueux</div>
                                                <div class="data-value"><?php echo e($intervention->diagnostic->nb_ic_hs); ?></div>
                                            </div>
                                            
                                            <div class="data-item">
                                                <div class="data-label">Masques défectueux</div>
                                                <div class="data-value"><?php echo e($intervention->diagnostic->nb_masques_hs); ?></div>
                                            </div>
                                            
                                            <div class="data-item">
                                                <div class="data-label">Fake PCB posé</div>
                                                <div class="data-value" style="font-size: 1rem;"><?php echo e($intervention->diagnostic->pose_fake_pcb == 1 ? 'Oui' : 'Non'); ?></div>
                                            </div>
                                        </div>
                                        
                                        <?php if($intervention->diagnostic->cause): ?>
                                        <div style="margin-top: 1rem;">
                                            ...
                                            <div class="cause-badge cause-<?php echo e($intervention->diagnostic->cause); ?>">
                                                <?php if($intervention->diagnostic->cause == 'usure_normale'): ?>
                                                    Usure normale
                                                <?php elseif($intervention->diagnostic->cause == 'choc'): ?>
                                                    Dommage physique
                                                <?php elseif($intervention->diagnostic->cause == 'defaut_usine'): ?>
                                        ...
                                        <div style="margin-top: 1rem;">
                                            ...
                                            <div class="notes-box">
                                                <?php echo e($intervention->diagnostic->remarques); ?>
                                    ...
                                    <div class="details-section">
                                        ...
                                        <div style="margin-top: 1rem;">
                                            ...
                                            <div class="notes-box">
                                                <?php echo e($intervention->reparation->actions_effectuees); ?>

                                            </div>
                                        </div>
                                        
                                        <?php if($intervention->reparation->pieces_remplacees): ?>
                                        <div style="margin-top: 1rem;">
                                            ...
                                            <div class="notes-box">
                                                <?php echo e($intervention->reparation->pieces_remplacees); ?>
                                        ...
                                        <div style="margin-top: 1rem;">
                                            <div style="margin-bottom: 0.5rem; font-size: 0.75rem; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.025em;">Remarques</div>
                                            <div class="notes-box">
                                                <?php echo e($intervention->reparation->remarques); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php $__currentLoopData = $module->interventions->sortBy('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $intervention): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($intervention->diagnostic): ?>
                    totalLEDs += <?php echo e($intervention->diagnostic->nb_leds_hs); ?>;
                    totalICs += <?php echo e($intervention->diagnostic->nb_ic_hs); ?>;
                    totalMasques += <?php echo e($intervention->diagnostic->nb_masques_hs); ?>;
                    
                    dates.push('<?php echo e($intervention->created_at->format('d/m')); ?>');
                    ledsCounts.push(<?php echo e($intervention->diagnostic->nb_leds_hs); ?>);
                    icsCounts.push(<?php echo e($intervention->diagnostic->nb_ic_hs); ?>);
                    masquesCounts.push(<?php echo e($intervention->diagnostic->nb_masques_hs); ?>);
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH /var/www/gmao/resources/views/suivi/module.blade.php ENDPATH**/ ?>