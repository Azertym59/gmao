...
<?php $component->withAttributes([]); ?>
    ...
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center">
            <h1 class="text-2xl font-semibold text-white">Modification de l'imprimante <?php echo e($printer->name); ?></h1>
            <a href="<?php echo e(route('printers.index')); ?>" class="bg-gray-600 hover:bg-gray-500 text-white px-4 py-2 rounded-lg transition-all duration-300 flex items-center">
        ...
        <div class="glassmorphism rounded-lg overflow-hidden shadow-lg">
            <form action="<?php echo e(route('printers.update', $printer)); ?>" method="POST" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="<?php echo e(old('name', $printer->name)); ?>" 
                ...
                <div>
                    ...
                    <select name="model" id="model" 
                        ...
                        ?>
                        <option value="Brother QL-820NWB" <?php echo e($currentModel == 'Brother QL-820NWB' ? 'selected' : ''); ?>>Brother QL-820NWB</option>
                        <option value="Brother QL-800" <?php echo e($currentModel == 'Brother QL-800' ? 'selected' : ''); ?>>Brother QL-800</option>
                        <option value="Brother QL-700" <?php echo e($currentModel == 'Brother QL-700' ? 'selected' : ''); ?>>Brother QL-700</option>
                        <option value="Zebra ZD410" <?php echo e($currentModel == 'Zebra ZD410' ? 'selected' : ''); ?>>Zebra ZD410</option>
                        <option value="Dymo LabelWriter 450" <?php echo e($currentModel == 'Dymo LabelWriter 450' ? 'selected' : ''); ?>>Dymo LabelWriter 450</option>
                        <option value="Autre" <?php echo e($currentModel == 'Autre' ? 'selected' : ''); ?>>Autre</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="connection_type" id="connection_type" 
                        ...
                        ?>
                        <option value="network" <?php echo e($currentConnectionType == 'network' ? 'selected' : ''); ?>>Réseau (IP)</option>
                        <option value="usb" <?php echo e($currentConnectionType == 'usb' ? 'selected' : ''); ?>>USB</option>
                        <option value="bluetooth" <?php echo e($currentConnectionType == 'bluetooth' ? 'selected' : ''); ?>>Bluetooth</option>
                    </select>
                </div>

                <!-- Adresse IP (conditionnelle) -->
                <div id="ip_address_container" class="<?php echo e($printer->options['connection_type'] ?? '' == 'network' ? '' : 'hidden'); ?>">
                    <label for="ip_address" class="block text-sm font-medium text-text-secondary mb-2">Adresse IP</label>
                    <input type="text" name="ip_address" id="ip_address" value="<?php echo e(old('ip_address', $printer->options['ip_address'] ?? '')); ?>" 
                           class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-accent-blue focus:border-transparent"
                ...
                <div id="brother_roll_container">
                    ...
                    <select name="brother_roll" id="brother_roll" 
                        ...
                        ?>
                        <option value="DK-22205" <?php echo e($currentRoll == 'DK-22205' ? 'selected' : ''); ?>>DK-22205 (62mm x continu)</option>
                        <option value="DK-22210" <?php echo e($currentRoll == 'DK-22210' ? 'selected' : ''); ?>>DK-22210 (29mm x continu)</option>
                        <option value="DK-22214" <?php echo e($currentRoll == 'DK-22214' ? 'selected' : ''); ?>>DK-22214 (12mm x continu)</option>
                        <option value="DK-11201" <?php echo e($currentRoll == 'DK-11201' ? 'selected' : ''); ?>>DK-11201 (29mm x 90mm, adresse standard)</option>
                        <option value="DK-11202" <?php echo e($currentRoll == 'DK-11202' ? 'selected' : ''); ?>>DK-11202 (62mm x 100mm, expédition)</option>
                        <option value="DK-11208" <?php echo e($currentRoll == 'DK-11208' ? 'selected' : ''); ?>>DK-11208 (38mm x 90mm)</option>
                        <option value="DK-11209" <?php echo e($currentRoll == 'DK-11209' ? 'selected' : ''); ?>>DK-11209 (62mm x 29mm, adresse petite)</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="label_format" id="label_format" 
                        ...
                        ?>
                        <option value="62mm" <?php echo e($currentFormat == '62mm' ? 'selected' : ''); ?>>62mm (standard)</option>
                        <option value="29mm" <?php echo e($currentFormat == '29mm' ? 'selected' : ''); ?>>29mm (petite)</option>
                        <option value="12mm" <?php echo e($currentFormat == '12mm' ? 'selected' : ''); ?>>12mm (très petite)</option>
                        <option value="38mm" <?php echo e($currentFormat == '38mm' ? 'selected' : ''); ?>>38mm (moyenne)</option>
                        <option value="102mm" <?php echo e($currentFormat == '102mm' ? 'selected' : ''); ?>>102mm (large)</option>
                        <option value="17mm" <?php echo e($currentFormat == '17mm' ? 'selected' : ''); ?>>17mm (très petite)</option>
                        <option value="predefined" <?php echo e($currentFormat == 'predefined' ? 'selected' : ''); ?>>Format prédéfini</option>
                        <option value="custom" <?php echo e($currentFormat == 'custom' ? 'selected' : ''); ?>>Format personnalisé</option>
                    </select>
                </div>
                ...
                <div id="print_mode_container">
                    ...
                    <select name="print_mode" id="print_mode" 
                        ...
                        ?>
                        <option value="raster" <?php echo e($currentPrintMode == 'raster' ? 'selected' : ''); ?>>Raster (recommandé)</option>
                        <option value="template" <?php echo e($currentPrintMode == 'template' ? 'selected' : ''); ?>>P-touch Template</option>
                        <option value="escp" <?php echo e($currentPrintMode == 'escp' ? 'selected' : ''); ?>>ESC/P</option>
                    </select>
                ...
                <div id="custom_format_container" class="<?php echo e($currentFormat == 'custom' ? '' : 'hidden'); ?>">
                    <label for="custom_format" class="block text-sm font-medium text-text-secondary mb-2">Dimensions personnalisées (mm)</label>
                    <div class="flex space-x-3">
                        <input type="number" name="custom_width" id="custom_width" value="<?php echo e(old('custom_width', $printer->options['custom_width'] ?? '')); ?>" 
                        ...
                        <input type="number" name="custom_height" id="custom_height" value="<?php echo e(old('custom_height', $printer->options['custom_height'] ?? '')); ?>" 
                               class="w-1/2 bg-gray-800/50 border border-gray-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-accent-blue focus:border-transparent"
                               placeholder="Hauteur">
                    </div>
                </div>
                ...
                <input type="hidden" name="label_width" id="label_width" value="<?php echo e($printer->options['label_width'] ?? ''); ?>">
                <input type="hidden" name="label_height" id="label_height" value="<?php echo e($printer->options['label_height'] ?? ''); ?>">
                ...
                <div class="border-t border-gray-700 pt-6">
                    ...
                    <div class="flex items-center mb-4">
                        <input type="checkbox" name="is_default" id="is_default" value="1" <?php echo e(old('is_default', $printer->is_default) ? 'checked' : ''); ?>
                    ...
                    <div>
                        ...
                        <select name="dpi" id="dpi" 
                                class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-accent-blue focus:border-transparent">
                            <option value="300" <?php echo e(old('dpi', $printer->options['dpi'] ?? '300') == '300' ? 'selected' : ''); ?>>300 DPI (standard)</option>
                            <option value="600" <?php echo e(old('dpi', $printer->options['dpi'] ?? '') == '600' ? 'selected' : ''); ?>>600 DPI (haute qualité)</option>
                            <option value="203" <?php echo e(old('dpi', $printer->options['dpi'] ?? '') == '203' ? 'selected' : ''); ?>>203 DPI (basse qualité)</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="flex justify-end space-x-3 border-t border-gray-700 pt-6">
                    <a href="<?php echo e(route('printers.index')); ?>" class="px-4 py-2 border border-gray-600 text-gray-300 rounded-lg hover:bg-gray-700 transition-colors">
                        Annuler
                    </a>
...
<?php endif; ?><?php /**PATH /var/www/gmao/resources/views/printers/edit.blade.php ENDPATH**/ ?>