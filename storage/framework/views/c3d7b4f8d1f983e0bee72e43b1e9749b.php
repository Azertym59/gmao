                    ...
                    <div id="diagnostic-summary" class="mb-6 bg-blue-900/20 p-4 rounded-lg border border-blue-500/20">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="p-3 bg-gray-800/50 rounded-lg border border-blue-500/30">
                                <div class="text-2xl text-blue-400 font-bold leds-hs-value"><?php echo e($diagnostic->nb_leds_hs); ?></div>
                                <p class="text-gray-300 text-sm">LEDs défectueuses</p>
                            </div>
                            <div class="p-3 bg-gray-800/50 rounded-lg border border-purple-500/30">
                                <div class="text-2xl text-purple-400 font-bold ics-hs-value"><?php echo e($diagnostic->nb_ic_hs); ?></div>
                                <p class="text-gray-300 text-sm">ICs défectueux</p>
                            </div>
                            <div class="p-3 bg-gray-800/50 rounded-lg border border-amber-500/30">
                                <div class="text-2xl text-amber-400 font-bold masques-hs-value"><?php echo e($diagnostic->nb_masques_hs); ?></div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
                            <div class="p-3 bg-gray-800/50 rounded-lg border border-gray-700">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-bold <?php echo e($diagnostic->pose_fake_pcb ? 'text-red-400' : 'text-gray-400'); ?> fake-pcb-needed">
                                        <?php echo e($diagnostic->pose_fake_pcb ? 'Oui' : 'Non'); ?>
                                ...
                                <div class="flex justify-between mt-2">
                                    ...
                                    <span class="font-bold text-gray-300">
                                        <?php if($diagnostic->cause === 'usure_normale'): ?>
                                            Usure normale
                                        <?php elseif($diagnostic->cause === 'choc'): ?>
                                            Choc/Impact
                                        <?php elseif($diagnostic->cause === 'defaut_usine'): ?>
                                            Défaut d'usine
                                        <?php elseif($diagnostic->cause === 'autre'): ?>
                                            Autre cause
                                        <?php else: ?>
                                            Non précisée
                                        <?php endif; ?>
                            ...
                            <div class="p-3 bg-gray-800/50 rounded-lg border border-gray-700">
                                ...
                                <p class="text-gray-300 mt-1"><?php echo e($diagnostic->remarques); ?></p>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                                        ...
                                        <div id="leds-replaced-counter" class="bg-gray-800/80 rounded-lg p-4 text-center border border-blue-600/30 shadow">
                                            ...
                                            <div class="flex items-center justify-center space-x-4">
                                                ...
                                                <div class="counter-display text-4xl font-bold text-blue-500 w-16">
                                                    <?php echo e(old('reparation_nb_leds_remplacees', $intervention->reparation->nb_leds_remplacees ?? $diagnostic->nb_leds_hs ?? 0)); ?>
                                            ...
                                            <input id="reparation_nb_leds_remplacees" type="hidden" name="reparation_nb_leds_remplacees" value="<?php echo e(old('reparation_nb_leds_remplacees', $intervention->reparation->nb_leds_remplacees ?? $diagnostic->nb_leds_hs ?? 0)); ?>" />
                                        </div>
                                        ...
                                        <div id="ics-replaced-counter" class="bg-gray-800/80 rounded-lg p-4 text-center border border-purple-600/30 shadow">
                                            ...
                                            <div class="flex items-center justify-center space-x-4">
                                                ...
                                                <div class="counter-display text-4xl font-bold text-purple-500 w-16">
                                                    <?php echo e(old('reparation_nb_ic_remplaces', $intervention->reparation->nb_ic_remplaces ?? $diagnostic->nb_ic_hs ?? 0)); ?>
                                            ...
                                            <!-- Champ caché pour stocker la valeur -->
                                            <input id="reparation_nb_ic_remplaces" type="hidden" name="reparation_nb_ic_remplaces" value="<?php echo e(old('reparation_nb_ic_remplaces', $intervention->reparation->nb_ic_remplaces ?? $diagnostic->nb_ic_hs ?? 0)); ?>" />
                                        </div>
                                        ...
                                        <div id="masques-replaced-counter" class="bg-gray-800/80 rounded-lg p-4 text-center border border-amber-600/30 shadow">
                                            ...
                                            <div class="flex items-center justify-center space-x-4">
                                                ...
                                                <div class="counter-display text-4xl font-bold text-amber-500 w-16">
                                                    <?php echo e(old('reparation_nb_masques_remplaces', $intervention->reparation->nb_masques_remplaces ?? $diagnostic->nb_masques_hs ?? 0)); ?>
                                            ...
                                            <!-- Champ caché pour stocker la valeur -->
                                            <input id="reparation_nb_masques_remplaces" type="hidden" name="reparation_nb_masques_remplaces" value="<?php echo e(old('reparation_nb_masques_remplaces', $intervention->reparation->nb_masques_remplaces ?? $diagnostic->nb_masques_hs ?? 0)); ?>" />
                                        </div>
                                    </div>
                                        ...
                                        <div id="fake-pcb-counter" class="bg-gray-800/80 rounded-lg p-4 text-center border border-red-600/30 shadow">
                                            ...
                                            <div class="flex items-center justify-center space-x-4">
                                                ...
                                                <div class="counter-display text-4xl font-bold text-red-500 w-16">
                                                    <?php echo e(old('reparation_fake_pcb_nb', $intervention->reparation->fake_pcb_nb ?? 0)); ?>
                                            ...
                                            <!-- Champ caché pour stocker la valeur -->
                                            <input id="reparation_fake_pcb_nb" type="hidden" name="reparation_fake_pcb_nb" value="<?php echo e(old('reparation_fake_pcb_nb', $intervention->reparation->fake_pcb_nb ?? 0)); ?>" />
                                        </div>
                                    </div>
