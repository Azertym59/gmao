...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 text-center">
            <img src="<?php echo e(asset('images/Logo rectangle V2.png')); ?>" alt="TecaLED Logo" class="h-48 mx-auto mb-6">
            
            <?php if(auth()->check() && isset(auth()->user()->client)): ?>
            <p class="text-2xl mb-6 text-white font-medium">Bienvenue <?php echo e(auth()->user()->client->civilite); ?> <?php echo e(auth()->user()->client->getNomCompletSansDoublonAttribute()); ?></p>
            <?php endif; ?>
            ...
            <div class="glassmorphism-static overflow-hidden shadow-xl rounded-xl">
                <div class="p-6 text-text-primary">
                    ...
                    <div class="grid grid-cols-3 md:grid-cols-6 gap-4 mb-8">
                        <a href="<?php echo e(route('chantiers.index')); ?>" class="glassmorphism-static flex flex-col items-center p-4 rounded-2xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
                        ...
                        <a href="<?php echo e(route('produits.index')); ?>" class="glassmorphism-static flex flex-col items-center p-4 rounded-2xl border border-green-500/20 hover:border-green-500/40 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
                        ...
                        <a href="<?php echo e(route('interventions.index')); ?>" class="glassmorphism-static flex flex-col items-center p-4 rounded-2xl border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
                        ...
                        <a href="<?php echo e(route('clients.index')); ?>" class="glassmorphism-static flex flex-col items-center p-4 rounded-2xl border border-amber-500/20 hover:border-amber-500/40 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
                        ...
                        <a href="<?php echo e(route('dalles.index')); ?>" class="glassmorphism-static flex flex-col items-center p-4 rounded-2xl border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
                        ...
                        <a href="<?php echo e(route('modules.index')); ?>" class="glassmorphism-static flex flex-col items-center p-4 rounded-2xl border border-rose-500/20 hover:border-rose-500/40 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
                            ...
                            <div class="flex items-center mb-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-white">
                                        <?php echo e(\App\Models\Chantier::where('etat', 'en_cours')->count()); ?>

                                    </p>
                                </div>
                            </div>
                            <div class="mt-2 text-center">
                                <a href="<?php echo e(route('chantiers.index', ['filter_etat' => 'en_cours'])); ?>" class="btn-action btn-primary text-xs px-2 py-1 w-full inline-block">Voir tous</a>
                            </div>
                        </div>
                        ...
                        <div class="glassmorphism-static rounded-2xl p-5 border border-red-500/20 hover:border-red-500/40 transition-all duration-300 hover:shadow-lg">
                            <div class="flex items-center mb-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-white">
                                        <?php echo e($chantiersUrgents->count()); ?>

                                    </p>
                                </div>
                            </div>
                            <div class="mt-2 text-center">
                                <a href="<?php echo e(route('chantiers.index', ['filter_urgent' => 'true'])); ?>" class="btn-action btn-primary text-xs px-2 py-1 w-full inline-block">Voir tous</a>
                            </div>
                        </div>
                        ...
                        <div class="glassmorphism-static rounded-2xl p-5 border border-green-500/20 hover:border-green-500/40 transition-all duration-300 hover:shadow-lg">
                            <div class="flex items-center mb-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-white">
                                        <?php echo e(\App\Models\Chantier::where('etat', 'termine')->count()); ?>

                                    </p>
                                </div>
                            </div>
                            <div class="mt-2 text-center">
                                <a href="<?php echo e(route('chantiers.index', ['filter_etat' => 'termine'])); ?>" class="btn-action btn-primary text-xs px-2 py-1 w-full inline-block">Voir tous</a>
                            </div>
                        </div>
                        ...
                        <div class="glassmorphism-static rounded-2xl p-5 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 hover:shadow-lg">
                            <div class="flex items-center mb-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-white">
                                        <?php echo e(\App\Models\Intervention::where('is_completed', false)->count()); ?>

                                    </p>
                                </div>
                            </div>
                            <div class="mt-2 text-center">
                                <a href="<?php echo e(route('interventions.index', ['filter_status' => 'active'])); ?>" class="btn-action btn-primary text-xs px-2 py-1 w-full inline-block">Voir toutes</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex items-center mb-2 justify-between">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-2xl font-bold text-white">
                                            <?php echo e($statsInterventions['modules_repares'] ?? 0); ?>
                        ...
                        <div class="glassmorphism-static rounded-2xl p-5 border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300 hover:shadow-lg">
                            <div class="mb-2">
                                ...
                                <p class="text-2xl font-bold text-white mt-2">
                                    <?php echo e($statsInterventions['total_composants'] ?? 0); ?>

                                </p>
                            </div>
                            <div class="text-xs text-gray-400 grid grid-cols-3 gap-1">
                                <div>LEDs: <?php echo e($statsInterventions['nb_leds_remplacees'] ?? 0); ?></div>
                                <div>ICs: <?php echo e($statsInterventions['nb_ic_remplaces'] ?? 0); ?></div>
                                <div>Masques: <?php echo e($statsInterventions['nb_masques_remplaces'] ?? 0); ?></div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center mb-2 justify-between">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-2xl font-bold text-white">
                                            <?php echo e($statsInterventions['taux_reussite'] ?? 0); ?>%
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="text-xs text-gray-400">
                                <div>Interventions terminées: <?php echo e($statsInterventions['interventions_terminees'] ?? 0); ?></div>
                                <div>Temps moyen: <?php echo e($statsInterventions['temps_moyen_format'] ?? "00h 00m 00s"); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                        ...
                        <div class="glassmorphism-static rounded-2xl border border-red-500/20 overflow-hidden transition-all duration-300 hover:shadow-lg">
                            <div class="px-5 py-4 border-b border-gray-700 bg-gradient-to-r from-red-900/30 to-transparent flex justify-between items-center">
                                ...
                                <span class="text-xs text-red-400 bg-red-500/10 rounded-full py-1 px-2"><?php echo e($chantiersUrgents->count()); ?></span>
                            </div>
                            <div class="p-4">
                                <?php if($chantiersUrgents->count() > 0): ?>
                                    <div class="space-y-3">
                                        <?php $__currentLoopData = $chantiersUrgents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chantier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="bg-gray-800/40 hover:bg-gray-800/60 p-4 rounded-xl border border-gray-700 transition-all duration-300">
                                                <div class="flex items-center justify-between">
                                                    <div>
                                                        <a href="<?php echo e(route('chantiers.show', $chantier)); ?>" class="font-medium text-white hover:text-red-400 flex items-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                            </svg>
                                                            <?php echo e($chantier->reference ?? $chantier->nom); ?>

                                                        </a>
                                                        <div class="text-sm text-gray-400 ml-7">
                                                            <?php echo e($chantier->client->societe ?? $chantier->client->nom_complet ?? 'Client inconnu'); ?>
                                                ...
                                                <div class="mt-3">
                                                    <div class="flex justify-between text-xs text-gray-400 mb-1">
                                                        ...
                                                        <span><?php echo e($chantier->pourcentage_avancement ?? 0); ?>%</span>
                                                    </div>
                                                    <div class="h-1.5 w-full bg-gray-700 rounded-full overflow-hidden">
                                                        <div class="h-full bg-red-500 rounded-full" style="width: <?php echo e($chantier->pourcentage_avancement ?? 0); ?>%"></div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="glassmorphism-static rounded-2xl border border-blue-500/20 overflow-hidden transition-all duration-300 hover:shadow-lg">
                            <div class="px-5 py-4 border-b border-gray-700 bg-gradient-to-r from-blue-900/30 to-transparent flex justify-between items-center">
                                ...
                                <a href="<?php echo e(route('chantiers.index')); ?>" class="text-xs text-blue-400 hover:underline">Voir tous</a>
                            </div>
                            <div class="p-4">
                                <?php
                                    $chantiersEnCours = \App\Models\Chantier::with('client')
                                                        ...
                                                        ->get();
                                ?>
                                <?php if($chantiersEnCours->count() > 0): ?>
                                    <div class="space-y-3">
                                        <?php $__currentLoopData = $chantiersEnCours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chantier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="bg-gray-800/40 hover:bg-gray-800/60 p-4 rounded-xl border border-gray-700 transition-all duration-300">
                                                <div class="flex items-center justify-between">
                                                    <div>
                                                        <a href="<?php echo e(route('chantiers.show', $chantier)); ?>" class="font-medium text-white hover:text-blue-400 flex items-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                                            </svg>
                                                            <?php echo e($chantier->reference ?? $chantier->nom); ?>
                                                    ...
                                                    <a href="<?php echo e(route('chantiers.show', $chantier)); ?>" class="btn-action btn-primary text-xs px-3 py-1 transition-transform hover:scale-105">
                                                        Voir
                                                    </a>
                                                </div>
                                                <div class="mt-3">
                                                    <div class="flex justify-between text-xs text-gray-400 mb-1">
                                                        <span>Progression</span>
                                                        <span><?php echo e($chantier->pourcentage_avancement ?? $chantier->progression ?? 0); ?>%</span>
                                                    </div>
                                                    <div class="h-1.5 w-full bg-gray-700 rounded-full overflow-hidden">
                                                        <div class="h-full bg-blue-500 rounded-full" style="width: <?php echo e($chantier->pourcentage_avancement ?? $chantier->progression ?? 0); ?>%"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                        ...
                        <div class="glassmorphism-static rounded-2xl border border-purple-500/20 overflow-hidden transition-all duration-300 hover:shadow-lg">
                            <div class="px-5 py-4 border-b border-gray-700 bg-gradient-to-r from-purple-900/30 to-transparent flex justify-between items-center">
                                ...
                                <a href="<?php echo e(route('interventions.index')); ?>" class="text-xs text-purple-400 hover:underline">Voir toutes</a>
                            </div>
                            <div class="p-4">
                                <?php
                                    $dernieresInterventions = \App\Models\Intervention::with(['module.dalle.produit.chantier.client', 'technicien'])
                                                    ...
                                                    ->get();
                                ?>
                                <?php if($dernieresInterventions->count() > 0): ?>
                                    <div class="space-y-3">
                                        <?php $__currentLoopData = $dernieresInterventions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $intervention): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="bg-gray-800/40 hover:bg-gray-800/60 p-3 rounded-xl border border-gray-700 transition-all duration-300">
                                                <div class="flex justify-between items-start">
                                                    <div>
                                                        <a href="<?php echo e(route('interventions.show', $intervention)); ?>" class="font-medium text-white flex items-center hover:text-purple-400">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                            </svg>
                                                            <?php echo e($intervention->technicien->name ?? 'Technicien'); ?> - Module #<?php echo e($intervention->module_id); ?>

                                                        </a>
                                                        <?php if($intervention->module && $intervention->module->dalle && $intervention->module->dalle->produit): ?>
                                                            <div class="ml-7 text-sm text-gray-400">
                                                                <strong>Société:</strong> <?php echo e($intervention->module->dalle->produit->chantier->client->societe ?? 'N/A'); ?>

                                                            </div>
                                                            <div class="ml-7 text-sm text-gray-400">
                                                                <strong>Produit:</strong> <?php echo e($intervention->module->dalle->produit->marque); ?> <?php echo e($intervention->module->dalle->produit->modele); ?>

                                                            </div>
                                                            <div class="ml-7 text-sm text-gray-400">
                                                                <strong>Specs:</strong> Pitch <?php echo e($intervention->module->dalle->produit->pitch); ?>mm | 
                                                                Bain <?php echo e($intervention->module->dalle->produit->bain_couleur ?? 'N/A'); ?>
                                                    ...
                                                    <div class="flex flex-col items-end">
                                                        <div class="flex items-center mb-2">
                                                            <div class="text-sm text-gray-400 mr-2">
                                                                <?php echo e($intervention->updated_at->format('d/m/Y')); ?>
                                                        ...
                                                        <a href="<?php echo e(route('interventions.show', $intervention)); ?>" class="btn-action btn-primary text-xs px-3 py-1 transition-transform hover:scale-105">
                                                            Voir l'intervention
                                                        </a>
                                                    </div>
                                                </div>
                                                <?php if($intervention->temps_total): ?>
                                                    <div class="mt-1 text-sm text-gray-400">
                                                        Durée: <?php echo e(gmdate('H:i:s', $intervention->temps_total)); ?>
                        ...
                        <div class="glassmorphism-static rounded-2xl border border-green-500/20 overflow-hidden transition-all duration-300 hover:shadow-lg">
                            <div class="px-5 py-4 border-b border-gray-700 bg-gradient-to-r from-green-900/30 to-transparent flex justify-between items-center">
                                ...
                                <a href="<?php echo e(route('chantiers.index')); ?>" class="text-xs text-green-400 hover:underline">Voir tous</a>
                            </div>
                            <div class="p-4">
                                <?php
                                    $chantiersTermines = \App\Models\Chantier::with('client')
                                                ...
                                                ->get();
                                ?>
                                <?php if($chantiersTermines->count() > 0): ?>
                                    <div class="space-y-3">
                                        <?php $__currentLoopData = $chantiersTermines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chantier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="bg-gray-800/40 hover:bg-gray-800/60 p-4 rounded-xl border border-gray-700 transition-all duration-300">
                                                <div class="flex items-center justify-between">
                                                    <div>
                                                        <a href="<?php echo e(route('chantiers.show', $chantier)); ?>" class="font-medium text-white hover:text-green-400 flex items-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                            </svg>
                                                            <?php echo e($chantier->reference ?? $chantier->nom); ?>
                                                        ...
                                                        <div class="text-xs text-gray-400 mt-1 ml-7">
                                                            Terminé le <?php echo e($chantier->updated_at->format('d/m/Y')); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="p-5">
                                ...
                                <div class="flex justify-between items-center">
                                    <div class="flex space-x-2">
                                        <a href="<?php echo e(route('chantiers.create')); ?>" class="btn-action btn-secondary text-xs px-3 py-1 transition-transform hover:scale-105">
                                            Nouveau
                                        </a>
                                        <a href="<?php echo e(route('chantiers.index')); ?>" class="btn-action btn-primary text-xs px-3 py-1 transition-transform hover:scale-105">
                                            Voir tous
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="glassmorphism-static rounded-2xl border border-green-500/20 overflow-hidden transition-all duration-300 hover:shadow-lg">
                            ...
                            <div class="p-5">
                                ...
                                <div class="flex justify-between items-center">
                                    <div class="flex space-x-2">
                                        <a href="<?php echo e(route('produits.create')); ?>" class="btn-action btn-secondary text-xs px-3 py-1 transition-transform hover:scale-105">
                                            Nouveau
                                        </a>
                                        <a href="<?php echo e(route('produits.index')); ?>" class="btn-action btn-primary text-xs px-3 py-1 transition-transform hover:scale-105">
                                            Voir tous
                                        </a>
                                    </div>
                                </div>
...
<?php endif; ?>
<?php /**PATH /var/www/gmao/resources/views/dashboard.blade.php ENDPATH**/ ?>